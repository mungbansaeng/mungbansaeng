...
<div class="admin_container">
    <div class="admin_contentBox">
        <h3 class="admin_tit">주문조회</h3>
        <div class="admin_infobox flex-vc-hl-container">
            <div class="search_box flex-hsb-container">
                <div class="search_select">
                    <select>
                        <option value="orderNo">주문번호</option>
                        <option value="file">회원아이디</option>
                        <option value="depthType">주문자명</option>
                        <option value="depthType">휴대폰번호</option>
                    </select>
                </div>
...
<script>
    ...
    function viewList (type = "") {
        ...
        $.ajax({
            ...
            dataType: "json",
            async: true,
            url: "/admin/controller/orderController",
            global: false,
            data: form.serialize(),
            traditional: true,
            ...
            success:function(data){
                ...
                if (data[1]['totalCount'] > 0) {
                    ...
                    contentList = "<div class='admin_tbody_list flex-vc-hsb-container'><div class='empty_list flex-vc-hc-container'>주문 내역이 없습니다.</div></div>";
