                ...
                <div class="admin_info admin_fullbox">
                    <div class="admin_table">
                        <div class="admin_thead flex-vc-hsb-container">
                            ...
                            <div class="col-300-list">회원아이디</div>
                            <div class="col-300-list">상품명</div>
                            <div class="col-title-list">문의내용</div>
                            <div class="col-ip-list">문의일시</div>
                        </div>
...
<script>
    ...
    function viewList (type = "") {
        ...
        if (type == "search") {
            ...
            $("#productQnaForm").append("<input type='hidden' class='searchType' name='searchType' value='" + searchType + "'>");

            $("#productQnaForm").append("<input type='hidden' class='searchText' name='searchText' value='" + searchText + "'>");
            ...
            success:function(data){
                ...
                if (data[1]['totalCount'] > 0) {
                    ...
                    for (ol=0; ol < data[2].length; ol++) {
                        ...
                        contentList += "<div class='admin_tbody_list'><a href='./orderModify.php?orderNo=" + data[2][ol]['orderNo'] + "' class='flex-vc-hsb-container'><div class='col-num-list flex-vc-hc-container'><input type='checkbox' class='checkEach' id='check" + data[2][ol]['idx'] + "'><label for='check" + data[2][ol]['idx'] + "' onclick='checkEach(this);'><p class='vb_designCheck'><span class='vb_designChecked'></span></p></label></div><div class='col-num-list flex-vc-hc-container'>" + sort + "</div><div class='col-300-list flex-vc-hc-container'>" + data[2][ol]['id'] + "</div><div class='col-300-list flex-vc-hc-container'>" + data[2][ol]['id'] + "</div><div class='col-title-list flex-vc-hc-container'>" + data[2][ol]['orderNo'] + "</div><div class='col-ip-list flex-vc-hc-container'>" + date + "</div></a></div>";
