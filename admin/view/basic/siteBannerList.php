        ...
        <div class="admin_infobox flex-vc-hl-container">
            <div class="search_box flex-hsb-container">
                ...
                <div class="search_text">
                    ...
                    <select onchange="searchVal(this);" class="hide">
                        <option value="">카테고리를 선택하세요.</option>
                        <option value="101">메인 최상단 배너</option>
                    </select>
                </div>
            ...
            <div class="admin_infobox flex-vc-hsb-container">
                ...
                <div class="admin_board_top flex-vb-hsb-container">
                    ...
                    <div class="admin_board_top_btn flex-vc-hr-container">
                        ...
                        <div class="admin_board_top_btn_list">
                            <input type="button" onclick="location.href='./siteBannerReg'" value="등록하기">
                        </div>
                    </div>
                </div>
                <div class="admin_info admin_fullbox">
                    <div class="admin_table">
                        <div class="admin_thead flex-vc-hsb-container">
                            ...
                            <div class="col-title-list">배너명</div>
...
<script>
            ...
            success:function(data){
                ...
                if (listCount > 0) {
                    ...
                    for (pcl=0; pcl < nowPageCount; pcl++) {
                        ...
                        listHtml += "<div class='admin_tbody_list flex-vc-hsb-container'><div class='col-num-list flex-vc-hc-container'><input type='checkbox' class='checkEach' id='check" + listData[pcl]['idx'] + "'><label for='check" + listData[pcl]['idx'] + "' onclick='checkEach(this);'><p class='vb_designCheck'><span class='vb_designChecked'></span></p></label></div><div class='col-num-list flex-vc-hc-container'>" + sort + "</div><div class='col-title-list admin_tbody_title flex-vc-hl-container'><a href='./siteBannerModify?depth=1&idx=" + listData[pcl]['idx'] + "' class='flex-vc-hl-container'><p>" + listData[pcl]['title'] + "</p></a></div><div class='col-show-list flex-vc-hc-container'><input type='checkbox' name='showYn' id='showYn" + pcl + "' " + showYnChecked + "><label for='showYn" + pcl + "' onclick='boardShowYn(this);'><p class='switchCheck'><span class='switchChecked'></span></p><input type='hidden' class='boardFile' name='boardFile' value='" + listData[pcl]['file'] + "'></label></div><div class='col-order-list admin_tbody_order  flex-vc-hc-container'><ul class='order_arrow'><li onclick=\"sortChange(this, 'up', " + listData[pcl]['sort'] + ")\">▲</li><li onclick=\"sortChange(this, 'down', " + listData[pcl]['sort'] + ")\">▼</li></ul></div></div>";
    ...
    function selectDel () {
        ...
        for (i=0; i < listLength; i++) {
            ...
            if (checked == true) {
                ...
                let categoryTitle = $(".admin_tbody_list").eq(i).find(".col-title-list").text();
                ...
                $("#produtCategoryForm").append("<input type='hidden' name='categoryTitle[]' class='del_categoryTitle' value='" + categoryTitle + "'>");
    ...
    function changeSearch (object) {

        if ($(object).val() == "type") {

            $(".search_text select option[value='']").prop("selected", true);

            $(".search_text input[type='text']").addClass("hide");

            $(".search_text input[type='text']").removeClass("show");

            $(".search_text select").addClass("show");

            $(".search_text select").removeClass("hide");

        } else {

            $(".search_text input[type='text']").val("");

            $(".search_text input[type='text']").addClass("show");

            $(".search_text input[type='text']").removeClass("hide");

            $(".search_text select").addClass("hide");

            $(".search_text select").removeClass("show");
