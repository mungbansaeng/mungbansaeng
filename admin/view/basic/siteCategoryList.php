...
<div class="admin_container">
    <div class="admin_contentBox">
        <h3 class="admin_tit">사이트 카테고리</h3>
        <div class="admin_infobox flex-vc-hl-container">
            <div class="search_box flex-hsb-container">
                <div class="search_select">
                    <select onchange="changeSearch(this);">
                        <option value="title">카테고리명</option>
                        <option value="file">파일명</option>
                        <option value="depthType">카테고리 타입</option>
                    </select>
                </div>
                <div class="search_text">
                    <input type="text" placeholder="검색어를 입력하세요." onkeydown="searchEnter();" class="show">
                    <select onchange="searchVal(this);" class="hide">
                        <option value="">카테고리 타입을 선택하세요.</option>
                        <option value="100">소개 페이지</option>
                        <option value="201">리스트 게시판</option>
                        <option value="202">이미지 게시판</option>
                        <option value="203">웹진형 게시판</option>
                        <option value="204">Q&A 게시판</option>
                        <option value="206">문의 게시판</option>
                        <option value="401">상품 게시판</option>
                        <option value="402">상품 베스트 게시판</option>
                        <option value="403">후기 게시판</option>
                    </select>
                </div>
            ...
            <div class="admin_infobox flex-vc-hsb-container">
                ...
                <div class="admin_board_top flex-vb-hsb-container">
                    ...
                    <div class="admin_board_top_btn flex-vc-hr-container">
                        ...
                        <div class="admin_board_top_btn_list">
                            <input type="button" onclick="location.href='./siteCategoryReg'" value="등록하기">
                        </div>
                    </div>
                </div>
                <div class="admin_info admin_fullbox">
                    <div class="admin_table">
                        <div class="admin_thead flex-vc-hsb-container">
                            ...
                            <div class="col-title-list">카테고리명</div>
