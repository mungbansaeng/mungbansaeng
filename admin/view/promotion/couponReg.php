...
<div class="admin_container">
    <div class="admin_contentBox">
        ...
        <form id="couponForm">
            ...
            <input type="hidden" name="act" class="act" value="view">
            <div class="admin_infobox flex-vc-hsb-container">
                ...
                <div class="admin_info admin_halfbox">
                    ...
                    <div>
                        <div class="selectbox noMargin_selectbox">
                            ...
                            <ul class="selectbox_depth couponType_selectBox">
                                <li data-val="1" class="flex-vc-hl-container" onclick="selectboxClick(this);">일반쿠폰</li>
                                <li data-val="2" class="flex-vc-hl-container" onclick="selectboxClick(this);">무료배송쿠폰</li>
                                <li data-val="3" class="flex-vc-hl-container" onclick="selectboxClick(this);">생일쿠폰</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="admin_info admin_halfbox">
                    ...
                    <div>
                        <ul class="coupon_listBox flex-vc-hl-container">
                            <li>
                                <input type="radio" id="couponLimit1" name="couponLimit" value="CA" checked>
                                <label for="couponLimit1">
                                    <p class="o_designCheck">
                                        <span class="o_designChecked"></span>
                                    </p>
                                    <span>무한</span>
                            ...
                            <li class="coupon_rtList">
                                <input type="radio" id="couponLimit2" name="couponLimit" value="CB">
                                <label for="couponLimit2">
                                    <p class="o_designCheck">
                                        <span class="o_designChecked"></span>
                                    </p>
                                    <span>한정</span>
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if (data[0] == "success") {
                ...
                if (data[1]['memberLevelName'] !== "") {

                    let couponDataValue = $(".couponType_selectBox").find("li").length + 1;

                    for (mc=0; mc < data[1].length; mc++) {

                        memberLevelList += "<li data-val='" + couponDataValue + "' class='flex-vc-hl-container' onclick='selectboxClick(this);'>" + data[1][mc]['memberLevelName'] + " 등급 쿠폰</li>";

                        couponDataValue++;

                    }

                    $(".couponType_selectBox").append(memberLevelList);
