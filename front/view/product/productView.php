    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if (data[3] == "nonMember") { // 상품에 포인트가 따로 없을때 비회원 포인트 체크
                ...
                var point = Math.round(productPrice * data[1]['pointPercent'] + parseInt(<?=$config['videoReviewPoint']?>));
                ...
                var point = Math.round(productPrice * (memberLevelPoint[memberLevelIdx] / 100)) + parseInt(<?=$config['videoReviewPoint']?>);
